...
global_variables() {
    ...
    global_url="http://trrb.xyz/"

    # Your name
    global_author="trrb"
    # You can use twitter or facebook or anything for global_author_url
    global_author_url="http://twitter.com/trrb" 
    # Your email
    global_email="trrb@disroot.org"
    ...
    header_file="config/header.html"
    footer_file="config/footer.html"
